...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: "Content for the About page (history, mission, vision, chairman's message)";
  ...
  attributes: {
    approvalsNote: Schema.Attribute.Text;
    chairmanBody: Schema.Attribute.RichText;
    chairmanName: Schema.Attribute.String;
    chairmanPhoto: Schema.Attribute.Media<'images'>;
    chairmanQuote: Schema.Attribute.Text;
    chairmanTitle: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    foundationBody: Schema.Attribute.RichText;
    foundationEyebrow: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    timeline: Schema.Attribute.Component<'shared.year-fact', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiAdmissionEnquiryAdmissionEnquiry
  ...
  info: {
    description: 'Public admission enquiry form submissions';
  ...
  attributes: {
    ...
    cetStatus: Schema.Attribute.Enumeration<
      ['Appeared', 'Registered', 'Planning to register']
    >;
    ...
    status: Schema.Attribute.Enumeration<
      ['New', 'Contacted', 'Follow-up', 'Admitted', 'Rejected', 'Closed']
    > &
...
export interface ApiAdmissionAdmission extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Yearly admission process configuration';
    displayName: 'Admission Cycle';
  ...
  attributes: {
    ...
    cetCellUrl: Schema.Attribute.String;
    closeDate: Schema.Attribute.Date;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    documentsRequired: Schema.Attribute.JSON;
    eligibilityGeneral: Schema.Attribute.String;
    eligibilityReserved: Schema.Attribute.String;
...
export interface ApiCommitteeCommittee extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Statutory and administrative committees';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    members: Schema.Attribute.Component<'committee.member', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiDocumentDocument extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Approvals, notifications and official PDFs';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Approvals & Affiliation', 'Admissions', 'Fees', 'IQAC', 'Committees']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiFacultyFaculty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publications: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFeeFee extends Struct.CollectionTypeSchema {
  collectionName: 'fees';
  info: {
    description: 'FRA-approved fee line items';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['General', 'Reserved', 'Management/Institute', 'NRI']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    documentRef: Schema.Attribute.Media<'files'>;
    frequency: Schema.Attribute.Enumeration<
      ['Annual', 'Semester', 'One-time']
    > &
...
export interface ApiFeedbackSubmissionFeedbackSubmission
  ...
  info: {
    description: 'Stakeholder feedback and grievance submissions';
  ...
  attributes: {
    ...
    role: Schema.Attribute.Enumeration<
      ['Student', 'Alumni', 'Parent', 'Employer', 'Faculty']
    >;
    status: Schema.Attribute.Enumeration<['New', 'Reviewed', 'Archived']> &
      Schema.Attribute.DefaultTo<'New'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomepagePopupHomepagePopup extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Toggleable announcement popup shown on the homepage';
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'CMS-managed homepage sections';
...
export interface ApiIqacIqac extends Struct.CollectionTypeSchema {
  collectionName: 'iqac_records';
  info: {
    description: 'Yearly IQAC composition and reports';
    displayName: 'IQAC Record';
    pluralName: 'iqacs';
    singularName: 'iqac';
  };
  options: {
  ...
  attributes: {
    academicYear: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    active: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    aqarReport: Schema.Attribute.Media<'files'>;
    composition: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    functionsDescription: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::iqac.iqac'> &
      Schema.Attribute.Private;
    meetingMinutes: Schema.Attribute.Media<'files', true>;
...
export interface ApiLeadNoteLeadNote extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Follow-up notes on a CRM lead';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    createdByStaff: Schema.Attribute.Relation<'oneToOne', 'admin::user'>;
    followUpAt: Schema.Attribute.DateTime;
    ...
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['Open', 'In Progress', 'Closed']> &
...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Admissions CRM lead record';
    displayName: 'Lead';
    pluralName: 'leads';
    singularName: 'lead';
  };
  ...
  attributes: {
    assignedTo: Schema.Attribute.Relation<'oneToOne', 'admin::user'>;
    convertedFromEnquiry: Schema.Attribute.Relation<
      'oneToOne',
      'api::admission-enquiry.admission-enquiry'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    mobile: Schema.Attribute.String & Schema.Attribute.Required;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    notes: Schema.Attribute.Relation<'oneToMany', 'api::lead-note.lead-note'>;
    publishedAt: Schema.Attribute.DateTime;
    source: Schema.Attribute.Enumeration<
      ['Website', 'Walk-in', 'Referral', 'Call', 'Event', 'Other']
    > &
      Schema.Attribute.DefaultTo<'Website'>;
    status: Schema.Attribute.Enumeration<
      ['New', 'Contacted', 'Qualified', 'Admitted', 'Lost']
    > &
      Schema.Attribute.DefaultTo<'New'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiNavigationNavigation extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Site header/footer navigation links';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerGroup: Schema.Attribute.String;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Generic static content page';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiPlacementsPagePlacementsPage
  ...
  info: {
    description: 'Content for the Placements page (process, policy, disclaimer)';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    policyRules: Schema.Attribute.JSON;
    prepBody: Schema.Attribute.RichText;
    prepTitle: Schema.Attribute.String;
...
export interface ApiProgramProgram extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Academic programmes offered';
    displayName: 'Program';
    pluralName: 'programs';
  ...
  attributes: {
    active: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    careerOpportunities: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiQuickLinkQuickLink extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Horizontal quick-link buttons shown on the homepage';
...
export interface ApiRedirectRedirect extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'URL redirects for migrated content';
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global institute settings';
  ...
  attributes: {
    ...
    admissionsStatusLine: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    ...
    topBarAddress: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSpecializationSpecialization
  ...
  info: {
    description: 'MBA functional specialisation area';
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Alumni, student and recruiter testimonials';
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['Alumni', 'Student', 'Recruiter', 'Parent']
    > &
